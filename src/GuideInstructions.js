			        ...
			        switch (guide) {
			          ...
			          case 'key': return (
				          	<div className='row textColor'>
				          		...
				          		<div className='col-md-8 keyTable'>
					          		<div className="row insideRow">
					          			<div className='col-md-1 color' style={{backgroundColor: "#2D882D"}}>
					          			</div>
					          			<div className='col-md-5'>
					          				Highly undervalued - Draft Priority!
					          			</div>
					          			<div className='col-md-1 color' style={{backgroundColor: "#AA3939"}}>
					          			</div>
					          			<div className='col-md-5'>
					          		...
					          		<div className="row insideRow">
					          			<div className='col-md-1 color' style={{backgroundColor: "#55AA55"}}>
					          			</div>
					          			<div className='col-md-5'>
					          				Moderately undervalued - Target this player
					          			</div>
					          			<div className='col-md-1 color' style={{backgroundColor: "#D46A6A"}}>
					          			</div>
					          			<div className='col-md-5'>
					          		...
					          		<div className="row insideRow">
					          			<div className='col-md-1 color' style={{backgroundColor: "#88CC88"}}>
					          			</div>
					          			<div className='col-md-5'>
					          				Slightly undervalued - Good pick
					          			</div>
					          			<div className='col-md-1 color' style={{backgroundColor: "#FFAAAA"}}>
					          			</div>
					          			<div className='col-md-5'>
